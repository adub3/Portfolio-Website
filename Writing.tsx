                            ...
                            <div className="space-y-12">
                                {selectedPost.content.map((block, idx) => {
                                    switch(block.type) {
                                        ...
                                        case 'component':
                                            return (
                                                <figure key={idx} className="my-16 w-full pointer-events-auto">
                                                    <div className="w-full rounded-lg overflow-hidden border border-theme-border/10 bg-theme-text/5">    
                                                        {block.component}
                                                    </div>
                                                    {block.caption && (
                                                        <figcaption className="mt-4 text-center text-sm font-mono text-theme-text/40 italic uppercase tracking-widest">      
                                                            {block.caption}
                                                        </figcaption>
                                                    )}
                                                </figure>
                                        ...
                                        case 'iframe':
                                            return (
                                                <figure key={idx} className="my-16 w-full pointer-events-auto">
                                                    <div className="w-full rounded-lg overflow-hidden border border-theme-border/10 bg-theme-text/5" style={{ height: block.height || '500px' }}>
                                                        <iframe 
                                                            src={block.src} 
                                                            className="w-full h-full border-none"
                                                            title={block.caption || "Visualization"}
                                        ...
                                        case 'image':
                                            return (
                                                <figure key={idx} className="my-12">
                                                    <div className="w-full h-auto bg-theme-text/5 rounded-sm border border-theme-border/10 overflow-hidden group hover:border-theme-border/20 transition-colors">
                                                        <img 
                                                            src={block.src} 
                                                            alt={block.caption}
